...
Plain English: the thing to do and why. A TASK closes when the thing is done and no
current-state claim changed. Nothing is too small — housekeeping lives here rather
than in an untracked commit.
...
None. — OR — name the documents, unconditionally.
